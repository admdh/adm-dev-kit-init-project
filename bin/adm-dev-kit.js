...
const entryPoint = (data) => {
	var entryPointContent = "var app = require('adm-dev-kit');\n" +
...
const gulpfile = () => {
	var gulpfileContet = "var app = require('adm-dev-kit');\n" +
		"var pjson = require('./package.json');\n\n" +
		"app.build({\n" +
		"\tsrc: pjson.srcFolder,\n" +
...
const stylelintFile = (data) => {
	var stylelintContet = { "extends": data};
...
const exampleComponent = (src) => {
	...
	var mainLayoutContent = "doctype html\n" +
		"html\n" +
		"\thead\n" +
		"\t\tmeta(charset=\"UTF-8\")\n" +
	...
	var indexContent = "extends _layouts/_main.pug\n" +
		"block title\n" +
		"\ttitle ADM DEV KIT\n\n" +
		"block content\n" +
	...
	var cssVarsContent = "/* stylelint-disable */\n" +
		":root{\n"+
		"\t--ms-bases: 1, .6;\n"+
		"\t--ms-ratios: 1.414;\n"+
		"\t--primary-color: #000;\n"+
	...
	var hellowWorldContent = "link(href=\"index/hello-world/_hello-world.css\" type=\"text/css\" rel=\"stylesheet\")\n" +
		".hello-world\n" +
		"\th1 Hello, World!\n\n" +
	...
	var hellowWorldJS = "console.log('Hello, World!')";
